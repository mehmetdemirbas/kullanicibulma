#!/bin/bash
# KullanıcıBulucu 
# Author: @mehmetdemirbas
# https://github.com/mehmetdemirbas
...
read -p $'\e[1;92m[\e[0m\e[1;77mMehmetDemirbas\e[0m\e[1;92m] Bulmak İstediginiz Kullanıcı:\e[0m ' username
...
check_face=$(curl -s "https://www.facebook.com/$username" -L -H "Accept-Language: en" | grep -o 'Bulunamadı'; echo $?)
...
check_youtube=$(curl -s "https://www.youtube.com/$username" -L -H "Accept-Language: en" | grep -o 'Bulunamadı'; echo $?)
...
check1=$(curl -s -i "https://www.badoo.com/en/$username" -H "Accept-Language: en" -L | grep -o 'Bulunamadı' ; echo $?)
...
check1=$(curl -s -i "https://www.dailymotion.com/$username" -H "Accept-Language: en" -L | grep -o 'Bulunamadı' ; echo $?)
...
check1=$(curl -s -i "https://cash.me/$username" -H "Accept-Language: en" -L | grep -o 'Bulunamadı'; echo $?)
...
check1=$(curl -s -i "https://www.behance.net/$username" -H "Accept-Language: en" -L | grep -o 'Bulunamadı'; echo $?)
...
check1=$(curl -s -i "https://www.goodreads.com/$username" -H "Accept-Language: en" -L | grep -o '404 Bulunamadı' ; echo $?)
...
check1=$(curl -s -i "https://www.instructables.com/member/$username" -H "Accept-Language: en" -L | grep -o 'Bulunamadı' ; echo $?)
...
check1=$(curl -s -i "https://keybase.io/$username" -H "Accept-Language: en" -L | grep -o 'Bulunamadı' ; echo $?)
...
check1=$(curl -s -i "https://kongregate.com/accounts/$username" -H "Accept-Language: en" -L | grep -o 'Bulunamadı' ; echo $?)
...
check1=$(curl -s -i "https://$username.livejournal.com" -H "Accept-Language: en" -L | grep -o 'Bulunamadı' ; echo $?)
...
check1=$(curl -s -i "https://angel.co/$username" -H "Accept-Language: en" -L | grep -o 'Bulunamadı' ; echo $?)
...
check1=$(curl -s -i "https://foursquare.com/$username" -H "Accept-Language: en" -L | grep -o 'Bulunamadı' ; echo $?)
...
check1=$(curl -s -i "https://www.roblox.com/user.aspx?username=$username" -H "Accept-Language: en" -L | grep -o 'Bulunamadı' ; echo $?)
...
check1=$(curl -s -i "https://www.gumroad.com/$username" -H "Accept-Language: en" -L | grep -o 'Bulunamadı' ; echo $?)
...
check1=$(curl -s -i "https://500px.com/$username" -H "Accept-Language: en" -L | grep -o 'Bulunamadı' ; echo $?)
...
check1=$(curl -s -i "https://$username.contently.com" -H "Accept-Language: en" -L | grep -o 'Bulunamadı' ; echo $?)
...
check1=$(curl -s -i "https://blip.fm/$username" -H "Accept-Language: en" -L | grep -o 'Bulunamadı' ; echo $?)
...
check1=$(curl -s -i "https://www.codementor.io/$username" -H "Accept-Language: en" -L | grep -o 'HTTP/2 404\|404 Bulunamadı' ; echo $?)
...
check1=$(curl -s -i "https://www.reverbnation.com/$username" -H "Accept-Language: en" -L | grep -o 'HTTP/2 404\|404 Bulunamadı' ; echo $?)
...
check1=$(curl -s -i "https://www.designspiration.net/$username" -H "Accept-Language: en" -L | grep -o 'HTTP/2 404\|404 Bulunamadı' ; echo $?)
...
check1=$(curl -s -i "https://www.bandcamp.com/$username" -H "Accept-Language: en" -L | grep -o 'HTTP/2 404\|404 Bulunamadı' ; echo $?)
...
check1=$(curl -s -i "https://www.colourlovers.com/love/$username" -H "Accept-Language: en" -L | grep -o 'HTTP/2 404\|404 Bulunamadı' ; echo $?)
...
check1=$(curl -s -i "https://www.ifttt.com/p/$username" -H "Accept-Language: en" -L | grep -o 'HTTP/2 404\|404 Bulunamadı' ; echo $?)
...
check1=$(curl -s -i "https://www.ebay.com/usr/$username" -H "Accept-Language: en" -L | grep -o 'HTTP/2 404\|404 Bulunamadı\|eBay Profile - error' ; echo $?)
...
check1=$(curl -s -i "https://$username.slack.com" -H "Accept-Language: en" -L | grep -o 'HTTP/2 404\|404 Bulunamadı' ; echo $?)
...
check1=$(curl -s -i "https://www.okcupid.com/profile/$username" -H "Accept-Language: en" -L | grep -o 'HTTP/2 404\|404 Bulunamadı' ; echo $?)
...
check1=$(curl -s -i "https://www.trip.skyscanner.com/user/$username" -H "Accept-Language: en" -L | grep -o 'HTTP/2 404\|404 Bulunamadı\|HTTP/2 410' ; echo $?)
...
check1=$(curl -s -i "https://ello.co/$username" -H "Accept-Language: en" -L | grep -o 'HTTP/2 404\|404 Bulunamadı' ; echo $?)
...
check1=$(curl -s -i "https://$username.basecamphq.com/login" -H "Accept-Language: en" -L | grep -o 'HTTP/2 404\|404 Bulunamadı' ; echo $?)
